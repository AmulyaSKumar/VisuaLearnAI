...
- **Backend**: Express 5 with modular architecture, Supabase for data, Anthropic Codex for AI
...
### Widget Development
Widgets are self-contained HTML streamed from Codex via `show_widget` tool:
...
ANTHROPIC_API_KEY=...
ANTHROPIC_MODEL=Codex-sonnet-4-5
