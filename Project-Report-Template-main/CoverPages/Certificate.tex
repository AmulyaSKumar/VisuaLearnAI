...
\begin{tabular}{cccc}
	\Large &&\\
		& &\\
	\large Internal Guide &\large External Guide &\large Head of the Department &\large Principal\\
	& &\\
	\large\printGuideNameA & \large\printGuideNameB & \large\printHOD & \large\printPrincipal\\
	& & \\
\end{tabular}%
}
\end{table}
