\documentclass[12pt,twoside,a4paper]{book} % This style for A4 format.
...
\backgroundsetup{scale=1, angle=0, firstpage = false, opacity=0.5, position=current page.center, hshift=0pt, vshift=0pt, contents={\includegraphics[width=0.42\paperwidth]{Figures/RVlogoVecW}}}
